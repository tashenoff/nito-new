                    ...
                    h.find("iframe").each(function () {
                        ...
                        if (h.data("videoposter") != t && h.data("videoposter").length > 2 && h.data("autoplay") != true && !s) {
                            if (h.find(".tp-thumb-image").length == 0)
                                h.append('<div class="tp-thumb-image" style="cursor:pointer; position:absolute;top:0px;left:0px;width:100%;height:100%;background-image:url(' + h.data("videoposter") + '); background-size:contain"></div>');
        ...
        n.find(">ul:first >li").each(function (e) {
            ...
            s.append(
                '<div class="bullet thumb" style="background-color:' +
                    ...
                    u +
                    ') !important;background-size:contain;background-position:top center;"></div>'
            );
